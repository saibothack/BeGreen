...
{
    public class ProductCommentPageViewModels : ViewModelBase
    {
        ...
        [Obsolete]
        public ProductCommentPageViewModels()
        {
        ...
        private async Task EventSave()
        {
            ...
            {
                await Application.Current.MainPage.DisplayAlert("Error", "Por favor ingresa tus comentarios", "Aceptar");
            }
            else
            {
