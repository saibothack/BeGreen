...
namespace BeGreen.Models.Cart
{
    public class ProductDetails
    {
        ...
        public class ProducAttribute
        {
            public ProducAttributeOption option { get; set; }
            public List<ProducAttributeValue> values { get; set; }
        }

        public class ProducAttributeOption
        {
            public int id { get; set; }
            public string name { get; set; }
        }

        public class ProducAttributeValue
        {
            public int id { get; set; }
